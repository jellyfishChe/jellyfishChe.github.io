const tianxiaEl=document.getElementById("tianxia");
const no13El=document.getElementById("no13");
const no14El=document.getElementById("no14");
tianxiaEl.addEventListener('click',()=>{
    if(tianxiaEl.classList.contains("selected")){
        tianxiaEl.classList.remove("selected");
    }else{
        tianxiaEl.classList.add("selected");
    }
    listenCheck();
    updateCountainer();
});
no13El.addEventListener('click',()=>{
    if(no13El.classList.contains("selected")){
        no13El.classList.remove("selected");
    }else{
        no13El.classList.add("selected");
    }
    listenCheck();
    updateCountainer();
});
no14El.addEventListener('click',()=>{
    if(no14El.classList.contains("selected")){
        no14El.classList.remove("selected");
    }else{
        no14El.classList.add("selected");
    }
    listenCheck();
    updateCountainer();
});
...
function combineDragon(hc){
    ...
    switch(q){
        case 0:
            // remove 1 4 7 11 14 17 21 24 27 one time in hc 
            tmpRemove=[1,4,7,11,14,17,21,24,27];
            break;
        case 1:
            // remove 1 4 7 12 15 18 20 23 26 in hc
            tmpRemove=[1,4,7,12,15,18,20,23,26];
            break;
        case 2:
            // remove 2 5 8 10 13 16 21 24 27 in hc
            tmpRemove=[2,5,8,10,13,16,21,24,27];
            break;
        case 3:
            // remove 2 5 8 12 15 18 19 22 25 in hc
            tmpRemove=[2,5,8,12,15,18,19,22,25];
            break;
        case 4:
            // remove 3 6 9 10 13 16 20 23 26 in hc
            tmpRemove=[3,6,9,10,13,16,20,23,26];
            break;
        case 5:
            // remove 3 6 9 11 14 17 19 22 25 in hc
            tmpRemove=[3,6,9,11,14,17,19,22,25];
            break;
        default: return false;
    }
    for(let i=0,j=0;i<14 && j<tmpRemove.length;i++){
        if(hc[i]==tmpRemove[j]){
            hc[i]=0;
            j++;
        }
    }
    let res=mjDefault(hc);
    for(let i=0,j=0;i<14 && j<tmpRemove.length;i++){
        if(hc[i]==0){
            hc[i]=tmpRemove[j];
            j++;
